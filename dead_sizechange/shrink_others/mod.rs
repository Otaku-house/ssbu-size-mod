...
pub fn global_fighter_frame(fighter : &mut L2CFighterCommon) {
    unsafe {
        ...
        {
            if smash::app::lua_bind::StatusModule::status_kind(fighter.module_accessor) == *FIGHTER_STATUS_KIND_DEAD {
                ShieldModule::set_attack_mul(module_accessor, 1.0 / (mag * SCALE[entry_id]), *FIGHTER_SHIELD_KIND_GUARD);
            }
        }
